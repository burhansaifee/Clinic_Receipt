...
import { ClipboardList, FileText, Search, Plus, Trash2, Printer, PlusCircle, AlertCircle, LogOut, CheckCircle } from 'lucide-react';
      ...
      <header className="doctor-header no-print">
        <div className="header-left">
          ...
          <div className="title-group">
            ...
            <p>Workstation Profile: <strong>{currentUser}</strong></p>
          </div>
        </div>
        ...
        <div className="header-right">
          ...
          <button className="btn-signout" onClick={onLogout} title="Sign Out Profile">
            <LogOut size={16} />
            <span>Sign Out</span>
          </button>
        </div>
          ...
          <div className="writer-modal">
            ...
            <form onSubmit={handleSaveAndPrint} className="writer-form">
              ...
              <div className="writer-actions">
                ...
                <button type="submit" className="btn-primary btn-save-rx">
                  <Printer size={16} />
